...
import java.sql.*;
import java.util.*;
public class CreditThanks extends HttpServlet
{
	public void service(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException
  	{
	    ...
	    PrintWriter out = res.getWriter();
	   	...
	   	HttpSession CCThankssession = req.getSession(true);
	    cost=(Integer)CCThankssession.getValue("ba");
