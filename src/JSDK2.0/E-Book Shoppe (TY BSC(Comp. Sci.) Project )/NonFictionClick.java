...
public class NonFictionClick extends HttpServlet
{
 ...
 public void service(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException
    {
		...
		try
		{
			...
			ResultSet rs=st.executeQuery("Select * from BookTab");
				...
				out.println("<html>");
				out.println("<title>Non-Fiction..</title>");
					...
					out.println("<form action=\"http://localhost:8080/servlet/SessionNonFiction\">");
					...
					out.println("<font face=\"Mistral\" size=20 color=#208234><center>NonFiction</center>");
				    ...
				    while(rs.next())
				    {
				      ...
				      int s=rs.getInt(3);
				      if(sub.equals("Nonfiction")==true)
				  	  {
						   out.println("<tr align=center>");
						   out.println("<td><input type=checkbox name=NonFiction value="+s+"></td>");
