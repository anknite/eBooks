...
public class JstNonFiction extends HttpServlet
{
 ...
 public void service(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException
    {
    	...
    	try
		{
			...
			out.println("<title>NonFiction..</title>");
			...
			out.println("<font face=\"Mistral\" size=20 color=#208234><center>Non-Fiction</center></form>");
