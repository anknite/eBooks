...
public class AutobiographyClick extends HttpServlet
{
		...
		try
		{
			...
			ResultSet rs=st.executeQuery("Select * from BookTab");
				...
				out.println("<title>Autobiography..</title>");
					...
					out.println("<form action=\"http://localhost:8080/servlet/SessionAutobiography\">");
					...
					out.println("<font face=\"Mistral\" size=20 color=#208234><center>Autobiography</center>");
				    ...
				    while(rs.next())
				    {
				      ...
				      if(sub.equals("Autobiography")==true)
				  	  {
						   out.println("<tr align=center>");
						   out.println("<td><input type=checkbox name=Autobiography value="+s+"></td>");
